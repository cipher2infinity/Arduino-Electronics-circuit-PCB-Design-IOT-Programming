...
void Creat_File_Name()
{
  ...
  clock.getTime();                            //Getting time from DS1307

  itoa(clock.dayOfMonth, Temp_Buffer, 10);    //Converting integer value to ascii string
  strcat(File_Name, Temp_Buffer);             //Storing temperory buffer in file name buffer variable
  strcpy(Temp_Buffer, "");
  strcpy(File_Name, "_");                     //Includingh '_' in Filename
